...
{
    /// <inheritdoc />
    public partial class Identity_Users_Migration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    full_name = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_supplier_types_suppliers_supplier_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_supplier_types_supplier_id",
                table: "SupplierTypes",
                column: "supplier_id",
                unique: true);
        }
